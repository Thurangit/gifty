...
import { Bell, Gift, Home, Mail, User } from 'lucide-react';
...
.snowflake {
    color: withe;
    filter: drop-shadow(0 0 2px rgba(0, 104, 255, 0.5)) 
  ...
  .snowflake:hover {
    filter: drop-shadow(0 0 3px rgba(255, 255, 255, 0.9)) 
            drop-shadow(0 0 2px rgba(200, 200, 255, 0.8));
  }
...
export default DigitalGiftingPlatform;